...
export const COMPARE_MOCK_VEHICLES: CompareVehicle[] = [
  {
    ...
    year: '2024',
    brandColor: '#EB0A1E',
    imageUrl: 'https://cdn.motor1.com/images/mgl/ljVZ1/s1/2022-toyota-corolla-cross-us-spec.jpg',
    priceFrom: 'R$ 189.990',
    aiScore: 94,
    totalFields: 68,
    categoryScores: {
...

  {
    ...
    year: '2024',
    brandColor: '#002C5F',
    imageUrl: 'https://cdn.motor1.com/images/mgl/6Zo8rN/s1/hyundai-creta-n-line-azul-sapphire-2025.jpg',
    priceFrom: 'R$ 156.490',
    aiScore: 91,
    totalFields: 61,
    categoryScores: {
...

  {
    ...
    year: '2024',
    brandColor: '#001E50',
    imageUrl: 'https://cdn.motor1.com/images/mgl/pVmzg/s1/4x3/volkswagen-taos-launching-edition-250tsi-2022.webp',
    priceFrom: 'R$ 179.990',
    aiScore: 89,
    totalFields: 57,
    categoryScores: {
...

  {
    ...
    year: '2024',
    brandColor: '#4A4A4A',
    imageUrl: 'https://s2-autoesporte.glbimg.com/NxOOVEsAJZKH08Sn7gI5lgPyilI=/453x333:5551x3692/1008x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_59edd422c0c84a879bd37670ae4f538a/internal_photos/bs/2019/d/5/qPn2JxQYOkkEVZbLxPuA/imagem-55-.jpg',
    priceFrom: 'R$ 207.990',
    aiScore: 87,
    totalFields: 54,
    categoryScores: {
